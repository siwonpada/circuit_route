...
class SabreSwapEnv(gym.Env):
    ...
    def _convert_digraph(self):
        ...
        while len(process_nodes) > 0 and count < self._N:
    ...
    def _unpack_state(self) -> dict[str, np.ndarray]:
